...
class Constituent(Base):
    ...
    party_affiliation = Column(String(80), default="", nullable=False)
    registration_date = Column(Date, nullable=True)
    gender = Column(String(80), default="", nullable=False)
    phone = Column(String(80), default="", nullable=False)
    voting_district = Column(String(80), default="", nullable=False)
    historical_source_file = Column(String(500), default="", nullable=False)
    historical_source_year = Column(Integer, nullable=True)
    historical_match_status = Column(String(120), default="", nullable=False)
    historical_payload = Column(Text, default="", nullable=False)
    historical_enriched_at = Column(DateTime, nullable=True)
